...
export default function CarCard({ car, compact = false }: CarCardProps) {
  ...
  return (
    <Link href={`/cars/${car.id}`} className="block group">
      <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-stone-100 group-hover:shadow-md transition-shadow duration-200">
        ...
        <div className="p-3">
          ...
          <div className="flex items-start justify-between gap-1.5 mb-0.5">
            ...
            <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded-md flex-shrink-0 leading-none mt-0.5 ${categoryColors[car.category]}`}>
              {car.category}
            </span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <a
                ...
                className="w-7 h-7 bg-green-50 rounded-lg flex items-center justify-center hover:bg-green-100 transition-colors flex-shrink-0"
                aria-label="WhatsApp"
              >
              ...
              {/* View Details */}
              <span className="bg-amber-500 text-white text-[10px] font-bold px-2.5 py-1.5 rounded-xl leading-none">
                View
              </span>
            </div>
          </div>
